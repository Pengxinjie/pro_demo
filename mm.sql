...
CREATE TABLE `t_catalog`  (
  ...
  INDEX `fk_course_catalog`(`courseId`) USING BTREE,
  INDEX `fk_user_catalog`(`userId`) USING BTREE,
  CONSTRAINT `fk_course_catalog` FOREIGN KEY (`courseId`) REFERENCES `t_course` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_user_catalog` FOREIGN KEY (`userId`) REFERENCES `t_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学科目录' ROW_FORMAT = Compact;
...
CREATE TABLE `t_course`  (
  ...
  `orderNo` int(11) NULL DEFAULT NULL COMMENT '排序编号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_user_course`(`userId`) USING BTREE,
  CONSTRAINT `fk_user_course` FOREIGN KEY (`userId`) REFERENCES `t_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学科表\r\n' ROW_FORMAT = Compact;
...
INSERT INTO `t_course` VALUES (3, '大数据与云计算', NULL, '2019-08-08 00:00:00', 0, 1, 1);
INSERT INTO `t_course` VALUES (23, 'C', NULL, '2021-11-13 14:03:13', 0, 1, 1);
INSERT INTO `t_course` VALUES (25, 'scala', NULL, '2021-11-13 14:13:52', 1, 1, 1);
...
CREATE TABLE `t_dict`  (
  ...
  `dataType` int(11) NULL DEFAULT NULL COMMENT '数据的类型',
  `dataCode` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '数据的编码',
  `dataValue` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '数据内容',
  `dataTag` int(11) NULL DEFAULT NULL COMMENT '数据标志',
  `dataDesc` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '详情',
  `orderNo` int(11) NULL DEFAULT NULL COMMENT '排序编号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK_fk_id_pid`(`pid`) USING BTREE,
  CONSTRAINT `FK_fk_id_pid` FOREIGN KEY (`pid`) REFERENCES `t_dict` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `t_industry`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '公司名称',
  `remark` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `orderNo` int(11) NULL DEFAULT NULL COMMENT '排序编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '行业' ROW_FORMAT = Compact;
...
CREATE TABLE `t_permission`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '权限表' ROW_FORMAT = Compact;
...
CREATE TABLE `t_question`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `number` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '试题编号',
  `subject` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `type` int(11) NULL DEFAULT NULL COMMENT '题目类型： 1. 单选  2. 多选 5. 简答',
  `difficulty` int(11) NULL DEFAULT NULL COMMENT '难度： \r\n            0 简单\r\n            1 一般\r\n            2 困难',
  `analysis` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '答案解析',
  `analysisVideo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `remark` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `isClassic` int(11) NULL DEFAULT NULL COMMENT '是否精选题目\r\n            0 不是\r\n            1 是',
  `status` int(11) NULL DEFAULT NULL COMMENT '题目状态\r\n            0 待发布（待审核、已拒绝）\r\n            1 已发布（已审核）\r\n            2 已下架（已审核）',
  `reviewStatus` int(11) NULL DEFAULT NULL,
  `createDate` datetime NULL DEFAULT NULL,
  `userId` int(11) NULL DEFAULT NULL,
  `companyId` int(11) NULL DEFAULT NULL COMMENT '企业id',
  `catalogId` int(11) NOT NULL COMMENT '方向id',
  `courseId` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_catalog_question`(`catalogId`) USING BTREE,
  INDEX `fk_company_question`(`companyId`) USING BTREE,
  INDEX `FK_fk_user_question`(`userId`) USING BTREE,
  INDEX `fk_course_question`(`courseId`) USING BTREE,
  CONSTRAINT `fk_catalog_question` FOREIGN KEY (`catalogId`) REFERENCES `t_catalog` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_company_question` FOREIGN KEY (`companyId`) REFERENCES `t_company` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_course_question` FOREIGN KEY (`courseId`) REFERENCES `t_course` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_fk_user_question` FOREIGN KEY (`userId`) REFERENCES `t_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 663 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '试题表' ROW_FORMAT = Compact;
...
CREATE TABLE `t_question_item`  (
  ...
  `isRight` int(11) NULL DEFAULT NULL COMMENT '是否正确答案\r\n            0 不是\r\n            1 是',
  `questionId` int(11) NULL DEFAULT NULL COMMENT '隶属题目',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK_fk_question_item`(`questionId`) USING BTREE,
  CONSTRAINT `FK_fk_question_item` FOREIGN KEY (`questionId`) REFERENCES `t_question` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 104 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '试题选项' ROW_FORMAT = Compact;
...
CREATE TABLE `t_review_log`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `comments` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `status` int(11) NULL DEFAULT NULL COMMENT '审核状态\r\n            0 未审核\r\n            1 已审核\r\n            2 已拒绝',
  `questionId` int(11) NULL DEFAULT NULL,
  `userId` int(11) NULL DEFAULT NULL COMMENT '审核人ID',
  `createDate` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_question_review`(`questionId`) USING BTREE,
  INDEX `FK_fk_user_review`(`userId`) USING BTREE,
  CONSTRAINT `FK_fk_user_review` FOREIGN KEY (`userId`) REFERENCES `t_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_question_review` FOREIGN KEY (`questionId`) REFERENCES `t_question` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 2066 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '审核日志' ROW_FORMAT = Compact;
...
CREATE TABLE `t_tag`  (
  ...
  `orderNo` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_course_tag`(`courseId`) USING BTREE,
  INDEX `fk_user_tag`(`userId`) USING BTREE,
  CONSTRAINT `fk_course_tag` FOREIGN KEY (`courseId`) REFERENCES `t_course` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_user_tag` FOREIGN KEY (`userId`) REFERENCES `t_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `t_user` VALUES (2, 'test', '123', 0, 'zhangsan@mm.itheima.cn', '后台', '2019-08-08 00:00:00', '测试账号');
...
CREATE TABLE `t_wx_member`  (
  ...
  `avatarUrl` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  ...
  `cityId` int(11) NULL DEFAULT NULL,
  `courseId` int(11) NULL DEFAULT NULL,
  `lastCategoryKind` int(11) NULL DEFAULT NULL,
  `lastCategoryType` int(11) NULL DEFAULT NULL,
  `lastCategoryId` int(11) NULL DEFAULT NULL,
  `lastQuestionId` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_question_member`(`lastQuestionId`) USING BTREE,
  CONSTRAINT `fk_question_member` FOREIGN KEY (`lastQuestionId`) REFERENCES `t_question` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会员表\r\n' ROW_FORMAT = Compact;
...
CREATE TABLE `tr_company_industry`  (
  ...
  PRIMARY KEY (`companyId`, `industryId`) USING BTREE,
  INDEX `fk_ci_industry`(`industryId`) USING BTREE,
  CONSTRAINT `fk_ci_company` FOREIGN KEY (`companyId`) REFERENCES `t_company` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_ci_industry` FOREIGN KEY (`industryId`) REFERENCES `t_industry` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `tr_member_question`  (
  ...
  `questionId` int(11) NULL DEFAULT NULL,
  `isFavorite` int(11) NULL DEFAULT NULL COMMENT '是否收藏：0.否 1.是',
  `tag` int(11) NULL DEFAULT NULL COMMENT '做题标记\r\n            0 正确  \r\n            1 错误\r\n            2 理想\r\n            3 不理想',
  `answerResult` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK_fk_fq_member`(`memberId`) USING BTREE,
  INDEX `FK_fk_mq_question`(`questionId`) USING BTREE,
  CONSTRAINT `FK_fk_fq_member` FOREIGN KEY (`memberId`) REFERENCES `t_wx_member` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_fk_mq_question` FOREIGN KEY (`questionId`) REFERENCES `t_question` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信用户 试题 中间表' ROW_FORMAT = Compact;
...
CREATE TABLE `tr_question_tag`  (
  ...
  PRIMARY KEY (`questionId`, `tagId`) USING BTREE,
  INDEX `fk_qt_tag`(`tagId`) USING BTREE,
  CONSTRAINT `fk_qt_question` FOREIGN KEY (`questionId`) REFERENCES `t_question` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_qt_tag` FOREIGN KEY (`tagId`) REFERENCES `t_tag` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `tr_role_permission`  (
  ...
  INDEX `fk_rp_permission`(`permissionId`) USING BTREE,
  CONSTRAINT `fk_rp_permission` FOREIGN KEY (`permissionId`) REFERENCES `t_permission` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_rp_role` FOREIGN KEY (`roleId`) REFERENCES `t_role` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色权限关系表' ROW_FORMAT = Compact;
...
CREATE TABLE `tr_user_role`  (
  ...
  INDEX `fk_ru_role`(`roleId`) USING BTREE,
  CONSTRAINT `fk_ru_role` FOREIGN KEY (`roleId`) REFERENCES `t_role` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_ru_user` FOREIGN KEY (`userId`) REFERENCES `t_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户角色关系表' ROW_FORMAT = Compact;
